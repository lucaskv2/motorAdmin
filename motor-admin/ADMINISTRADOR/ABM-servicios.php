...
<body>
    ...
    <div class="container mt-4">
        ...
        <form method="POST" action="../php/servicios/crearServicio.php" class="mb-4 d-flex">
            <input type="text" name="nombre" class="form-control me-2" placeholder="Nuevo servicio" required>
    ...
    <div class="modal fade" id="editarModal" tabindex="-1" aria-labelledby="editarModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form id="formEditarServicio" method="POST" action="../php/servicios/editarServicio.php">
    ...
    <div class="modal fade" id="eliminarModal" tabindex="-1" aria-labelledby="eliminarModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="../php/servicios/eliminarServicio.php">
            <div class="modal-content">
                <div class="modal-header">
