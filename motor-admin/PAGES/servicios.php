    ...
    <section class="container my-5">
        <div class="row g-4">
            ...
            <div class="card h-100 text-center">
                <img src="ruta/servicio1.jpg" class="card-img-top" alt="Servicio 1">
                <div class="card-body">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
            <div class="card h-100 text-center">
                <img src="ruta/servicio2.jpg" class="card-img-top" alt="Servicio 2">
                <div class="card-body">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
            <div class="card h-100 text-center">
                <img src="ruta/servicio3.jpg" class="card-img-top" alt="Servicio 3">
                <div class="card-body">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
            <div class="card h-100 text-center">
                <img src="ruta/servicio4.jpg" class="card-img-top" alt="Servicio 4">
                <div class="card-body">
